/**
 * Inline SVG icon registry (Lucide-style, 24x24, stroke = currentColor).
 * Rendered by the <app-icon> component. Keeping icons inline avoids loading
 * an icon font and keeps them crisp and themeable via `currentColor`.
 */
